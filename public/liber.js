        ...
        with (locals || {}) {
            (function() {
                ...
                for (var i = 0; i < books.length; i++) {
                    ...
                    __stack.lineno = 5;
                    if (books[i].visible) {
                        buf.push('\n				<div class="w3-col">\n					<div class="book w3-card-4 w3-display-container" style="', escape((__stack.lineno = 7, books[i].styles.cover)), '">\n						<p class="author" style="', escape((__stack.lineno = 8, books[i].styles.author)), '">', escape((__stack.lineno = 8, books[i].authorDisplay)), '</p>\n						<p class="title" style="', escape((__stack.lineno = 9, books[i].styles.title)), "\">\n							<a href='/#", escape((__stack.lineno = 10, books[i].path)), '/read\' class="w3-text-black w3-hover-none w3-hover-text-white">', (__stack.lineno = 10, books[i].title), "</a>\n						</p>\n						");
                        __stack.lineno = 12;
                        if (books[i].subtitle1) {
                            buf.push('\n						<p class="subtitle1" style="', escape((__stack.lineno = 13, books[i].styles.subtitle1)), '">\n							', (__stack.lineno = 14, books[i].subtitle1), "</a>\n						</p>\n						");
                            __stack.lineno = 16;
                        }
                        buf.push("\n						");
                        __stack.lineno = 17;
                        if (books[i].subtitle2) {
                            buf.push('\n						<p class="subtitle1" style="', escape((__stack.lineno = 18, books[i].styles.subtitle2)), '">\n							', (__stack.lineno = 19, books[i].subtitle2), "</a>\n						</p>\n						");
                            __stack.lineno = 21;
                        }
                        buf.push('\n						<p class="publisher w3-display-bottommiddle" >liber</p>\n				   </div>\n				</div>\n				<div class="w3-rest"></div>\n			   ');
                        __stack.lineno = 26;
