                ...
                for (var i = 0; i < authors.length; i++) {
                    ...
                    if (authors[i].visible) {
                        ...
                        for (var j = 0; j < authors[i].works.length; j++) {
                            ...
                            buf.push('\n								<button id="open-infos-', escape((__stack.lineno = 50, work.id)), '" class="open-infos-btn btn" >Fiche</button>\n						   </div>\n						</div>\n					\n					');
                            __stack.lineno = 54;
                        }
                        buf.push("\n					</div>\n				</div>\n				");
                        __stack.lineno = 57;
