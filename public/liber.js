                ...
                buf.push('<div id="book">\n	<!--\n		STARTBOOK-CONTAINER\n	-->\n	<div id="bookContainer">\n		<!--\n			TOC-LARGE-DEVICE (outside textContainer) : width >= 1366\n		-->\n		' + function() {
                    ...
                    if (book.contribs.length > 1) {
                        ...
                        for (var j = 0; j < book.contribs.length; j++) {
                            buf.push('\n							<li>\n								<span class="contrib-role">', (__stack.lineno = 91, book.contribs[j].role), " : </span>\n								", (__stack.lineno = 92, book.contribs[j].name), " (", (__stack.lineno = 92, book.contribs[j].birth), "&nbsp;&ndash; ", (__stack.lineno = 92, book.contribs[j].death), ")\n							</li>\n						");
                            __stack.lineno = 94;
                        }
                        buf.push("\n						</ul>\n					</p>\n			  ");
                        __stack.lineno = 97;
                    } else if (book.contribs.length === 1) {
                        buf.push('\n					<p>\n						<span><b>Contribution : </b></span>\n						<br>\n						<ul>\n							<li>\n								<span class="contrib-role">', (__stack.lineno = 103, book.contribs[0].role), " : </span>\n								", (__stack.lineno = 104, book.contribs[0].name), " (", (__stack.lineno = 104, book.contribs[0].birth), "&nbsp;&ndash; ", (__stack.lineno = 104, book.contribs[0].death), ")\n							</li>\n						</ul>\n					</p>\n			  ");
                        __stack.lineno = 108;
                    }
                    buf.push('\n			  <p class="book-source"><b>Source : </b>\n				  <ul>\n					  <li>&Eacute;diteur : ', (__stack.lineno = 111, book.source.publisher), "</li>\n					  <li>Année de publication : ", (__stack.lineno = 112, book.source.year), "</li>\n				  </ul>\n			  </p>\n			  ");
                    __stack.lineno = 115;
                    if (book.description) {
                        buf.push("\n			  <div>", (__stack.lineno = 116, book.description), "</div>\n			  ");
                        __stack.lineno = 117;
                    }
                    buf.push('\n		  </div>\n	</div>\n</div>\n\n<div id="book-commands">\n	<button id="toggle-toc-large-device" title="Table des matières" type="button" class="w3-btn w3-card-2 w3-white" >Table</button>\n	<button id="toggle-tab-options" title="Options de lecture" type="button" class="w3-btn w3-card-2 w3-white" >Options</button>\n	<button id="toggle-tab-infos" title="Informations sur l\'ouvrage" type="button" class="w3-btn w3-card-2 w3-white" >Infos</button>\n	<button id="tab-add-bookmark" title="Insérer un signet" type="button" class="add-bookmark w3-btn w3-card-2 w3-white" >Signet</button>\n	<button id="tab-home-link" title="Quitter la lecture" type="button" class="home w3-btn w3-card-2 w3-white" >Retour</button>\n</div>\n	\n\n');
                    return buf.join("");
