            ...
            (function() {
                ...
                for (var i = 0; i < books.length; i++) {
                    buf.push("\n				\n				<!-- MODAL (INFOS) -->\n				" + function() {
                        ...
                        return buf.join("");
                    }() + '				\n				<div class="w3-col" style="text-align: center">\n					<div id="paper" style="background-image: url(', (__stack.lineno = 11, books[i].styles.image), ')">\n						<div id="', escape((__stack.lineno = 12, books[i].id)), '" class="book w3-card-4" style="', escape((__stack.lineno = 12, books[i].styles.cover)), '">\n							<p class="author" style="', escape((__stack.lineno = 13, books[i].styles.author)), '">', escape((__stack.lineno = 13, books[i].authorDisplay)), '</p>\n							<p class="title" style="', escape((__stack.lineno = 14, books[i].styles.title)), '">\n								', (__stack.lineno = 15, books[i].title), "\n							</p>\n							");
                    __stack.lineno = 17;
                    if (books[i].subtitle1) {
            ...
            (function() {
                ...
                for (var i = 0; i < books.length; i++) {
                    buf.push("\n				\n				<!-- MODAL (INFOS) -->\n				" + function() {
                        ...
                        buf.push('\n		</div>\n		<div id=footer class="w3-container w3-border-bottom">\n			<button id="close-infos-', escape((__stack.lineno = 63, books[i].id)), '" \n					class="close-infos-btn w3-button w3-text-gray w3-hover-none w3-hover-text-black w3-display-bottomright"\n					>Fermer</button>\n		</div>\n	</div>\n</div>\n');
                        return buf.join("");
                    }() + '				\n				<div class="w3-col" style="text-align: center">\n					<div id="paper" id="paper" style="background-image: url(', (__stack.lineno = 15, books[i].styles.image), ')">\n					<div id="', escape((__stack.lineno = 16, books[i].id)), '" class="book" style="', escape((__stack.lineno = 16, books[i].styles.cover)), '">\n						<p class="author" style="', escape((__stack.lineno = 17, books[i].styles.author)), '">', escape((__stack.lineno = 17, books[i].authorDisplay)), '</p>\n						<p class="title" style="', escape((__stack.lineno = 18, books[i].styles.title)), '">\n							', (__stack.lineno = 19, books[i].title), "\n						</p>\n						");
                    __stack.lineno = 21;
                    if (books[i].subtitle1) {
            ...
            (function() {
                ...
                for (var i = 0; i < books.length; i++) {
                    buf.push("\n				\n				<!-- MODAL (INFOS) -->\n				" + function() {
                        ...
                        buf.push('\n		</div>\n		<div id=footer class="w3-container w3-border-bottom">\n			<button id="close-infos-', escape((__stack.lineno = 63, books[i].id)), '" \n					class="close-infos-btn w3-button w3-text-gray w3-hover-none w3-hover-text-black w3-display-bottomright"\n					>Fermer</button>\n		</div>\n	</div>\n</div>\n');
                        return buf.join("");
                    }() + '				\n				<div class="w3-col" style="text-align: center">\n					<div id="paper" style="background-image: url(', (__stack.lineno = 10, books[i].styles.image), ')">\n					<div class="book" style="', escape((__stack.lineno = 11, books[i].styles.cover)), '">\n						<p class="author" style="', escape((__stack.lineno = 12, books[i].styles.author)), '">', escape((__stack.lineno = 12, books[i].authorDisplay)), '</p>\n						<p class="title" style="', escape((__stack.lineno = 13, books[i].styles.title)), '">\n							<span>', (__stack.lineno = 14, books[i].title), "</span>\n						</p>\n						");
                    __stack.lineno = 16;
                    if (books[i].subtitle1) {
                    ...
                    buf.push('\n						<p class="logo" style="', escape((__stack.lineno = 26, books[i].styles.logo)), '">\n							<span class="span1">L&rsquo;Intermédiaire</span><br/>\n							<span class="span2">éditions</span>\n						</p>\n				   </div>\n				   </div>\n				   <div id="book-btn" >\n						<button id="open-infos-', escape((__stack.lineno = 33, books[i].id)), '" class="open-infos-btn align-right w3-button">+ d\'infos</button>\n				   </div>\n				</div>\n				\n			');
                    __stack.lineno = 37;
                }
                buf.push("\n		</div>\n	</div>\n</div>\n");
            })();
...
var book = function book(container) {
	...
	var init = function init() {
		...
		for (var i = 0; i < openTocs.length; i++) {
			openTocs[i].addEventListener('click', function (event) {
	...
	_utils2.default.ajax(options).then(function (content) {
		...
		if (_dataStore2.default.getData('stylesheet')) {
			head.replaceChild(style, head.lastChild);
		} else {
			head.appendChild(style);
		}
		_dataStore2.default.setData('stylesheet', true);
	...
	_createClass(WebBook, [{
		...
		value: function insertBookmark() {
			...
			for (var i = 0; i < this._elements_all.length; i++) {
				var _elPosition = Math.round((0, _core2.default)(this._elements_all[i]).position().left) - this.getMarginX();
		...
		value: function goToBookmark(bookmark) {
			var el = this._elements_all[bookmark];
        ...
        with (locals || {}) {
            (function() {
                buf.push('<div id="book">\n	<!--\n		STARTBOOK-CONTAINER\n	-->\n	<div id="bookContainer">\n		<!--\n			TOC-LARGE-DEVICE (outside textContainer) : width >= 1366\n		-->\n		' + function() {
                    var buf = [];
                    buf.push('\n<div id="toc-large-device" class="w3-card-4" >\n	<button id="close-toc-large-device" type="button" class="w3-btn w3-card-4 w3-white" >Table</button>\n	<div id="toc-large-device-container" class="toc-content">\n		<div class="w3-padding-16">\n			<p class="w3-center">', (__stack.lineno = 6, book.authorDisplay), '</p>\n			<p class="w3-center text-uppercase">', (__stack.lineno = 7, book.title), '</p>\n		</div>\n		<div data-wb-toc class="w3-container"></div>\n	</div>\n</div>\n	\n<div id="tab-infos" class="w3-card-4">\n	<button id="close-tab-infos" type="button" class="w3-btn w3-card-4 w3-white" >Infos</button>\n	<div id="tab-infos-container">\n		   <div class="w3-padding-16">\n			  <p class="w3-center">', (__stack.lineno = 17, book.authorDisplay), '</p>\n			  <p class="w3-center text-uppercase">', (__stack.lineno = 18, book.title), '</p>\n		  </div>\n		  <div class="w3-container">\n			  <p><b>Titre : </b>', (__stack.lineno = 21, book.title), "</p>\n			  ");
                    __stack.lineno = 22;
                    if (book.subtitle1) {
                        buf.push("\n				<p><b>Sous-titre : </b>", (__stack.lineno = 23, book.subtitle1), "</p>\n			  ");
                        __stack.lineno = 24;
                    }
                    buf.push("\n			  ");
                    __stack.lineno = 25;
                    if (book.subtitle2) {
                        buf.push("\n				<p><b>Sous-sous-titre : </b>", (__stack.lineno = 26, book.subtitle2), "</p>\n			  ");
                        __stack.lineno = 27;
                    }
                    buf.push("\n			  <p><b>Année de parution : </b>", (__stack.lineno = 28, book.year), "</p>\n			  ");
                    __stack.lineno = 29;
                    if (book.authors.length > 1) {
                        buf.push("\n					<p>\n						<span><b>Auteurs :</b></span>\n						<br>\n						<ul>\n						");
                        __stack.lineno = 34;
                        for (var j = 0; j < book.authors.length; j++) {
                            buf.push("\n							<li>\n								", (__stack.lineno = 36, book.authors[j].name), " (", (__stack.lineno = 36, book.authors[j].birth), "&nbsp;&ndash; ", (__stack.lineno = 36, book.authors[j].death), ")\n							</li>\n						");
                            __stack.lineno = 38;
                        }
                        buf.push("\n						</ul>\n					</p>\n			  ");
                        __stack.lineno = 41;
                    } else if (book.authors.length === 1) {
                        buf.push("\n					<p><b>Auteur : </b>", (__stack.lineno = 42, book.authors[0].name), " (", (__stack.lineno = 42, book.authors[0].birth), "&nbsp;&ndash; ", (__stack.lineno = 42, book.authors[0].death), ")</p>\n			  ");
                        __stack.lineno = 43;
                    }
                    buf.push("\n			  ");
                    __stack.lineno = 44;
                    if (book.contribs.length > 1) {
                        ...
                        for (var j = 0; j < book.contribs.length; j++) {
                            buf.push('\n							<li>\n								<span class="contrib-role">', (__stack.lineno = 51, book.contribs[j].role), " : </span>\n								", (__stack.lineno = 52, book.contribs[j].name), " (", (__stack.lineno = 52, book.contribs[j].birth), "&nbsp;&ndash; ", (__stack.lineno = 52, book.contribs[j].death), ")\n							</li>\n						");
                            __stack.lineno = 54;
                        }
                        buf.push("\n						</ul>\n					</p>\n			  ");
                        __stack.lineno = 57;
                    } else if (book.contribs.length === 1) {
                        buf.push('\n					<p>\n						<span><b>Contribution : </b></span>\n						<br>\n						<ul>\n							<li>\n								<span class="contrib-role">', (__stack.lineno = 63, book.contribs[0].role), " : </span>\n								", (__stack.lineno = 64, book.contribs[0].name), " (", (__stack.lineno = 64, book.contribs[0].birth), "&nbsp;&ndash; ", (__stack.lineno = 64, book.contribs[0].death), ")\n							</li>\n						</ul>\n					</p>\n			  ");
                        __stack.lineno = 68;
                    }
                    buf.push('\n			  <p class="book-source"><b>Source : </b>\n				  <ul>\n					  <li>&Eacute;diteur : ', (__stack.lineno = 71, book.source.publisher), "</li>\n					  <li>Année de publication : ", (__stack.lineno = 72, book.source.year), "</li>\n				  </ul>\n			  </p>\n			  ");
                    __stack.lineno = 75;
                    if (book.description) {
                        buf.push("\n			  <div>", (__stack.lineno = 76, book.description), "</div>\n			  ");
                        __stack.lineno = 77;
                    }
                    ...
                    return buf.join("");
                }() + '		<!--\n			START SWING-CONTAINER : margin-left: 33% WHEN TOC-LARGE OPEN\n		-->\n		<div id="swing-container">\n			<!--\n				START TEXT-CONTAINER\n			-->\n			<div data-wb-text-container class="w3-card-4">\n				<!--\n					TOC (inside textContainer) : width < 1366\n				-->\n				<div id="toc">\n					<div data-wb-toc class="w3-container">\n						<button id="close-toc" type="button" class="w3-button w3-text-black w3-hover-none w3-display-topright">&times;</button>\n						<div id="toc-title" class="toc-content">\n							<p class="w3-center">', (__stack.lineno = 24, book.authorDisplay), '</p>\n							<p class="w3-center text-uppercase">', (__stack.lineno = 25, book.title), '</p>\n						</div>\n					</div>\n				</div>\n				<!--\n					TOP (inside textContainer)\n				-->\n				<div id="top">\n					<span class="wb-current-section-title"></span>\n				</div>\n				<!--\n					TEXT\n				-->\n				<div data-wb-text style="background-color: ', (__stack.lineno = 38, book.styles.color), "; background-image: url(", (__stack.lineno = 38, book.styles.image), "); font-family: ", escape((__stack.lineno = 38, book.styles.font)), '"></div>\n				<!--\n					BOTTOM (inside textContainer) : width < 768\n				-->\n				<div id="bottom">\n					<a id="home" href="/#/books/" class="home w3-button w3-hover-none w3-text-gray">&larr;</a>\n					<span class="wb-currentByTotal-pages"></span>\n					<button type="button" id="open-toc" class="open-toc w3-button w3-hover-none w3-text-gray">&colone;</button>\n				</div>\n				<!--\n					BOTTOM-LARGE (inside textContainer) : width >= 768\n				-->\n				<div id="bottom-large">\n					<span class="wb-currentByTotal-pages"></span>\n				</div>\n			<!--\n				END TEXT-CONTAINER\n			-->\n			</div>\n		<!--\n			END SWING-CONTAINER : margin-left: 33% WHEN TOC-LARGE OPEN\n		-->\n		</div>\n		<!--\n			NAVBAR-BOTTOM (outside textContainer) : width >= 768\n		-->\n		<div id="book-nav-bar-bottom">\n			<div class="w3-bar w3-large">\n				<div id="swing-bar">\n					<div id="book-nav-bar-bottom-controls">\n						<span id="home-large" class="home w3-button w3-hover-none">&larr;</span>\n						<div id="center">\n							<span id="backward-large" class="w3-button w3-hover-none">&lt;</span>\n							<span id="forward-large" class="w3-button w3-hover-none">&gt;</span>\n						</div>\n						<span id="open-toc-large" class="open-toc w3-button w3-hover-none">&colone;</span>\n					</div>\n				</div>\n			</div>\n		</div>\n	<!--\n		END BOOK-CONTAINER\n	-->\n	</div>\n</div>\n');
            })();
        }
        return buf.join("");
    } catch (err) {
                        ...
                        for (var j = 0; j < works.length; j++) {
                            ...
                            if (b.visible) {
                                ...
                                buf.push("\n							\n							<!-- MODAL (INFOS) -->\n							" + function() {
                                    ...
                                    buf.push('\n			  <p class="book-source"><b>Source : </b>\n				  <ul>\n					  <li>&Eacute;diteur : ', (__stack.lineno = 54, book.source.publisher), "</li>\n					  <li>Année de publication : ", (__stack.lineno = 55, book.source.year), "</li>\n				  </ul>\n			  </p>\n			  ");
                                    __stack.lineno = 58;
                                    if (book.description) {
                                    ...
                                    return buf.join("");
                                }() + '							\n							<div class="w3-col" style="text-align: center">\n								<div id="paper" style="background-image: url(', (__stack.lineno = 31, book.styles.image), ')">\n									<div id="', escape((__stack.lineno = 32, book.id)), '" class="book" style="', escape((__stack.lineno = 32, book.styles.cover)), '">\n										<p class="book-author" style="', escape((__stack.lineno = 33, book.styles.author)), '">', escape((__stack.lineno = 33, book.authorDisplay)), '</p>\n										<p class="title" style="', escape((__stack.lineno = 34, book.styles.title)), '">\n											', (__stack.lineno = 35, book.title), "\n										</p>\n										");
                                __stack.lineno = 37;
                                if (book.subtitle1) {
                                ...
                                buf.push('\n										<p class="logo" style="', escape((__stack.lineno = 47, book.styles.logo)), '">\n											<span class="span1">L&rsquo;Intermédiaire</span><br/>\n											<span class="span2">éditions</span>\n										</p>\n								   </div>\n							   </div>\n							   <div id="book-btn" >\n									<button id="open-infos-', escape((__stack.lineno = 54, book.id)), '" class="open-infos-btn align-right w3-button">+ d\'infos</button>\n							   </div>\n							</div>\n						   ');
                                __stack.lineno = 57;
                            }
                            buf.push("\n						");
                            __stack.lineno = 58;
