...
var book = function book(container) {
	...
	var init = function init() {
		...
		//FONT-SIZE
		//large
		fontSizeInputLarge.addEventListener('input', function (event) {
			text.style.opacity = '0';
		}, false);

		fontSizeInputLarge.addEventListener('change', function (event) {
