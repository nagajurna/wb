...
var WebBook = function () {
	...
	_createClass(WebBook, [{
		...
		value: function elementPageNumber(id) {
			...
			console.log(id);
			console.log("el position : " + Math.round((0, _jquery2.default)(el).position().left) - this.getMarginX());
			elPosition = elPosition % this._containerWidth !== 0 ? elPosition - elPosition % this._containerWidth : elPosition; //always at a page beginning
			...
			console.log("el page number before : " + elPageNumber);
			elPageNumber = elPageNumber - this._startPage;
			console.log("el page number after : " + elPageNumber);
			return elPageNumber;
		}
	}, {
		key: 'getSectionTitle',
		...
		value: function insertBookmark() {
			...
			for (var i = 0; i < this._elements.length; i++) {
				var elPosition = Math.round((0, _jquery2.default)(this._elements[i]).position().left) - this.getMarginX();
				elPosition = elPosition % this._containerWidth !== 0 ? elPosition - elPosition % this._containerWidth : elPosition; //always at a page beginning
		...
		value: function goToBookmark(bookmark) {
			var element = this._elements[bookmark];
